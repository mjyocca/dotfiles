...
return {
	...
	config = function()
		...
		-- TODO: Enable ruby/rails debugging
		-- ruby_config = {
		--   type = "ruby",
		--   request = "attach",
		--   name = "Attach to Rails Application in Docker",
		--   remote = true,
		--   port = 12345,
		--   server = "127.0.0.1",
		--   host = "127.0.0.1",
		...
		--   sourceFileMap = {
		--     ["/app"] = vim.fn.getcwd(),
		--     -- ["/app/app"] = vim.fn.getcwd() .. "/app", -- Maps container path to local path
		--     -- ["/app/lib"] = vim.fn.getcwd() .. "/lib",
		--     -- ["/app/app/models/**"] = vim.fn.getcwd() .. "/app/models/**",
		--   },
		-- }
		--
		...
		-- -- table.insert(dap.configurations.ruby, ruby_config)
		--
